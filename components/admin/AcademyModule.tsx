...
export const AcademyModule: React.FC<AcademyModuleProps> = ({ DataTable }) => {
    ...
    const [pendingIconFile, setPendingIconFile] = useState<File | null>(null);  // ícone da categoria aguardando upload
    ...
    const openCategoryModal = (category?: VideoCategory) => {
        ...
        setPendingIconFile(null);  // limpa arquivo pendente ao abrir modal
    ...
    const handleSaveCategory = async () => {
        ...
        try {
            ...
            // 🚀 Upload do ícone, se um arquivo foi selecionado
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex flex-col gap-1">
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        setPendingIconFile(null);
                                                        setEditingCategory({ ...editingCategory, icon_url: null });
                                                    }}
