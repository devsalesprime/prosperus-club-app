    ...
    const renderTable = () => {
        ...
        return (
            <div className="bg-slate-800 rounded-xl border border-slate-700 overflow-hidden mt-6">
                <AdminTable>
                    <table className="w-full min-w-[600px] text-left text-sm text-slate-400 whitespace-nowrap">
                        <thead>
    ...
    return (
        <div className="space-y-6">
            ...
            <AdminConfirmDialog
                ...
                message="Tem certeza que deseja cancelar esta homenagem? Esta ação não pode ser desfeita."
