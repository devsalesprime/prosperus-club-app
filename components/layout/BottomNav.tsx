...
const bottomNavItems = [
    ...
    { id: 'prosperus-tools', label: 'Tools', Icon: IconProsperus, view: ViewState.PROSPERUS_TOOLS },
            ...
            >
                ...
                <div style={{
                    ...
                    {bottomNavItems.map(item => {
                        ...
                        const textColorClass = isActive ? 'text-prosperus-gold-light' : 'text-prosperus-grey';
