...
import { Trophy, TrendingUp, ArrowRight, Loader2, ChevronUp } from 'lucide-react';
...
export const TopRankingPreview: React.FC<TopRankingPreviewProps> = ({ onViewFullRankings, onProfileClick }) => {
    ...
    return (
        <div className={`top-ranking-preview ${isOpen ? '' : 'collapsed'}`}>
            <div
