...
//
// ═══════════════════════════════════════════════════════════════
// REFATORADO (Operação Estilhaço):
// - Types → analytics/analyticsTypes.ts
// - Pure functions → analytics/analyticsCalculations.ts
// - Este arquivo = Facade (Supabase queries + event tracking)
// ═══════════════════════════════════════════════════════════════
...
export type {
    AnalyticsEventType, AnalyticsEvent, DeviceInfo,
    PageViewMetadata, VideoMetadata, ArticleMetadata, MessageMetadata,
    DashboardStats, DailyActivity, DailyAccessMetrics, TopContent, EventBreakdown,
    BenefitStats, TopBenefit, BenefitOverview, BenefitEngagement,
    NetworkingFunnel, TopRoiMember, ChurnRiskMember, AcademyCompletion, EventAttendance,
...
// Import pure calculations & session management
import {
    getOrCreateSessionId, resetSessionId, getSessionStartTime,
    getDeviceInfo, calcTrend,
    parseDailyActivityRow, parseTopContentRow, parseEventBreakdownRow,
